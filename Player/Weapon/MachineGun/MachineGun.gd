...
var streams = [
  preload("res://Player/SFX/Skull_Shot_1.ogg"),
  preload("res://Player/SFX/Skull_Shot_2.ogg"),
  preload("res://Player/SFX/Skull_Shot_3.ogg")
]
...
func _process(delta):
  ...
  if Input.is_action_pressed("shoot"):
    ...
    if shoot_time <= 0:
      EventBus.emit_signal("blood_paid", 1.5)
